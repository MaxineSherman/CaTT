%INTERO_IMPORT import data into an intero structure from the
%intero_data_importer spreadsheet
%   usage: dat = intero_import
%
...
sname = 'intero_data_imported.mat';
save(sname,'dat');
disp(sprintf('\n'));
