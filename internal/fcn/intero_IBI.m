%INTERO_IBI get the IBI of the cycle in which onset appeared, the onset
%expressed as time since the last R peak, and a vector of all IBIs.
%   usage: [onset_IBI , onset_tsinceR , all_IBI ] = intero_IBI(rpeaks_msec, onset)
%
%    INPUTS: 
...
function [onset_IBI, onset_tsinceR, allIBI] = intero_IBI( rpeaks_msec, onset )
